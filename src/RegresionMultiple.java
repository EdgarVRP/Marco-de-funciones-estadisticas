...
public class RegresionMultiple extends OperacionesBasicas{
	...
	double UPI=0,LPI=0;
	//ok
	public RegresionMultiple(double W[], double X[], double Y[], double Z[], double Wk, double Xk, double Yk) {
		this.w = W;
		this.x = X;
		this.y = Y;
		this.z = Z;
...
/*
	...
	*/
	...
	public String toString() {
		...
		for (int a = 0; a < 4; a++) {
			Resultado +=("Beta " + a + " es: " + Betas[a]) + "<br>";
		}
		Resultado += ("Zk (Las Horas proyectadas son: )"+ Zk +"<br>");
		Resultado += ("UPI (70%):"+ UPI +"<br>");
		Resultado += ("LPI (70%):"+ LPI +"<br><html>");
		return Resultado;
	}
}
